...
Gem::Specification.new do |s|
  ...
  s.summary = "Common configuration for RSpec and a dummy application"
  s.description = "Common configuration for RSpec and a dummy application"
